...
export class CDView extends VisualizerView {
         ...
         this._highlightSubscriber = {
            update: (field, value) => {
               if (field === 'highlightColors') {
                  ...
                  this.modelElement.onVisualizerChange?.(this.modelElement.getVisualizerJSON?.())
               } else if (field === 'highlightControl' && isSerializable<HighlightControlJSON>(value)) {
   ...
   updateFromJSON (json: CayleyDiagramModelJSON) {
      ...
      if (this._highlightModelProxy != null) {
         ...
         const data = isSerializable<HighlightControlJSON>(highlightControl) ? highlightControl.toJSON() : highlightControl
         ...
         if (data != null) {
            (this._highlightModelProxy.highlightControl as Serializable<HighlightControlJSON>).fromJSON(data)
         }
