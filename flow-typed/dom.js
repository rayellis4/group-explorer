/*  $GE3 indicates local mods made for GE3
 */
...
declare class Event {
  ...
  +target: Element; // $GE3 event targets always have 'closest' method
  /** @deprecated */
...
declare class Document extends Node {
  ...
  body: HTMLBodyElement;  /* $GE3 -- we always have body in document */
  +characterSet: string;
  /**
  ...
  getElementById(elementId: string): HTMLElement; /* $GE3 -- usually searching for our own elements */
