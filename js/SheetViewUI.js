...
class SheetEventUI {
    ...
    resizeElement(modelElement) {
        ...
        const sheetResizeModal = makeDialog(resizeHTML, { clientX: ghostLeft, clientY: ghostTop }, (_clickEvent) => {
    ...
    setupMove() {
        ...
        recognizeMoveResize(this.rootElement, (dx, dy, _dw, _dh, _isDrop, domElement) => {
    ...
    createLink(source, type, validTarget, clickAction) {
        ...
        const linkingDialogHTML = `<div id=linking-dialog style="resize: none">
        ...
        linkingDialog.addEventListener('pointermove', (event) => {
...
//# sourceMappingURL=SheetViewUI.js.map