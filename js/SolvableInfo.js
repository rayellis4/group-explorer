...
function makeSolvableGroupContent(group) {
    ...
    if (group.isAbelian) {
        htmlFragments.push(`<div>${group.name} is <a href="./help/rf-groupterms/index.html#solvable-group-solvable-decomposition">solvable</a>
        ...
        if (group.isSimple) {
            htmlFragments.push(`<div>In fact, it does not even have a
               <a href="./help/rf-groupterms/index.html#normal-subgroup">normal subgroup</a>
    ...
    htmlFragments.push(`<button class="gap-compute" data-GAP="checking if a group is solvable">Compute this in GAP</button>
      </details>`);
...
//# sourceMappingURL=SolvableInfo.js.map