...
export class AbstractDiagramDisplay {
    ...
    snapToAxis() {
        ...
        const q1 = new THREE.Quaternion()
            .setFromUnitVectors(position, new THREE.Vector3().setComponent(positionAxis, Math.sign(position.getComponent(positionAxis))));
        ...
        const q2 = new THREE.Quaternion()
            .setFromUnitVectors(up, new THREE.Vector3().setComponent(upAxis, Math.sign(up.getComponent(upAxis))));
    ...
    deleteAllSpheres() {
        ...
        const spheres = sphere_group.children;
    ...
    createLine(vertices) {
        ...
        geometry.setPositions(vertices.reduce((positions, vertex) => (positions.push(vertex.x, vertex.y, vertex.z), positions), []));
...
//# sourceMappingURL=AbstractDiagramDisplay.js.map